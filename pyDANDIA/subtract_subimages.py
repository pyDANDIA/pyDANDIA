...
def subtract_subimage(setup, kernel_directory_path, image_name,reduction_metadata):
    ...
    for substamp_idx in range(len(reduction_metadata.stamps[1])):
        ...
        data_image, data_image_unmasked = open_data_image(setup, data_image_directory, image_name, reference_stamps[substamp_idx][1], kernel_size, max_adu, xshift = x_shift, yshift = y_shift, sigma_smooth = 0, central_crop = maxshift, subset = subset_slice)       
