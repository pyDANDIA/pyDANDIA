...
def test_match_all_entries_with_starlist():
    ...
    query = 'SELECT code_id FROM software WHERE version ="'+params['version']+'"'
    params['software'] = phot_db.query_to_astropy_table(conn, query, args=())['code_id'][0]
    ...
    (matched_stars, unmatched_stars) = stage3_db_ingest.match_all_entries_with_starlist(setup,conn,params,starlist,
                                                     reduction_metadata,
                                                     1,transform,log)
