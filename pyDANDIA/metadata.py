...
class MetaData:
    ...
    def create_images_stats_layer(self):
        ...
        data_structure = [
            ['IM_NAME', 'FWHM_X', 'FWHM_Y', 'SKY', 'CORR_XY', 'NSTARS', 'FRAC_SAT_PIX','SYMMETRY','USE_PHOT','USE_REF'],
            ['S100', 'float', 'float', 'float', 'float', 'int', 'float','float','int','int'],
            [None, 'arcsec', 'arcsec', 'ADU_counts', None, None, None, None, None, None]
        ]
