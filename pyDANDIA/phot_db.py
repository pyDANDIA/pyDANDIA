...
class PhotometryPoints(TableDef):
    ...
    c_100_flux = 'DOUBLE PRECISION'
    c_105_flux_err = 'DOUBLE PRECISION'
    c_110_phot_scale_factor = 'REAL'
    c_115_phot_scale_factor_err = 'REAL'
    c_120_local_background = 'DOUBLE PRECISION'
    c_125_local_background_err = 'DOUBLE PRECISION'
    c_130_phot_type = 'TEXT'
