...
def run_stage1(setup):
    """Main driver function to run stage 1 of pyDANDIA: measurement of image properties.
    This stage populates the metadata with the FWHM and sky background for
    each image.
    """
    ...
    table_structure = [['IM_NAME','FWHM_X','FWHM_Y','SKY','CORR_XY'],
