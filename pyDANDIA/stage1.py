...
path_to_images = '/home/Tux/ytsapras/Programs/Workspace/pyDANDIA/trials/data/'
...
for im in images:
    sky, fwhm_y, fwhm_x, corr_xy = starfind.starfind(im, plot_it=True, write_log=True)
    # Write to the metadata file
    reduction_metadata.create_data_inventory_layer([im])
    reduction_metadata.save_a_layer_to_file(metadata_directory='/home/Tux/ytsapras/Programs/Workspace/pyDANDIA/trials/',metadata_name='pyDANDIA_metadata.fits',key_layer='data_inventory')
    reduction_metadata.add_column_to_layer(key_layer='data_inventory', new_column_name='fwhm_x', new_column_data='float', new_column_format=None, new_column_unit='arcsec')
